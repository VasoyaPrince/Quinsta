package com.example.quinsta.crop
...
fun ImageSelectionButton(
    elevation: androidx.compose.material3.FloatingActionButtonElevation = androidx.compose.material3.FloatingActionButtonDefaults.elevation(),
